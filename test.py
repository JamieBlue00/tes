...
code1 = input(str("Please input the path to the first code. "))
code2 = input(str("Please input the path to the second code. "))
...
if codetime[0] > codetime[1]:
    print("Your code is quicker by {} seconds!".format(codetime[0]-codetime[1]))
elif codetime[1] > codetime[0]:
    print("Your code is slower by {} seconds.".format(codetime[1]-codetime[0]))
elif codetime[1] == codetime[0]:
    print("Your code takes the same time as the fastest code!")
